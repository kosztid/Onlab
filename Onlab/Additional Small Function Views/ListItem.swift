...
struct ListItem_Previews: PreviewProvider {
    static var previews: some View {
        ListItem(todo: Todo(id:"aSD",name: "peldanev", description: "desc",date: "01/07/2022",isDone: false),presenter: TodoListPresenter(interactor: TodoListInteractor(model: DataModel())))
